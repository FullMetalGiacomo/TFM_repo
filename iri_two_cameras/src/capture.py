...
class Capture(object):
    ...
    def start(self):
        ...
        one = message_filters.Subscriber('cam_1/color/image_raw', Image)
        two = message_filters.Subscriber('cam_2/color/image_raw', Image)
        ts = message_filters.ApproximateTimeSynchronizer([one, two],1,0.1)
        self.i=0
